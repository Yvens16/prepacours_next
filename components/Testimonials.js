                  ...
                  <div className='xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:pb-0 pb-12'>
                    <div className='shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded'>
                      <div className='bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr'>
                        <p className='text-xl text-white pb-1'>Félix Timmel</p>
                      ...
                      <div className='pl-6 pr-6 pt-10 relative h-auto'>
                        ...
                        <p className='text-base text-gray-600 leading-8'>
                          Je recommande Emmanuel, compètent, sympa et a
                          l’écoute. C’est toujours un plaisir d’avoir cours et
                          les progrès qui suivent.
                        </p>
              ...
              <figure className='py-4'>
                <div className='flex flex-wrap justify-around'>
                  <div className='xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12'>
                    <div className='shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded'>
                      ...
                      <div className='pl-6 pr-6 pt-10 relative h-auto'>
                        ...
                        <p className='text-base text-gray-600 leading-8'>
                          J’ai apprécié le dispositif informatisé d’inscription
                          et de suivi, le sérieux et les compétences des
                          intervenants.
                        </p>
                        <div className='flex justify-end mt-2'>
                          <svg
                  ...
                  <div className='xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:pb-0 pb-12'>
                    <div className='shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded'>
                      <div className='bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr'>
                        <p className='text-xl text-white pb-1'>Sonia</p>
                        <p className='text-base text-indigo-200'>
                          Terminal S - 2020
                        </p>
                      </div>
                  ...
                  <div className='xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12'>
                    <div className='shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded'>
                      <div className='bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr'>
                        <p className='text-xl text-white pb-1'>Mathilde</p>
                        <p className='text-base text-indigo-200'>
                          Terminal ES - 2020
                        </p>
                      </div>
              ...
              <figure className='py-4'>
                <div className='flex flex-wrap justify-around'>
                  <div className='xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12'>
                    <div className='shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded'>
                      <div className='bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr'>
                        <p className='text-xl text-white pb-1'>Mehdi</p>
                        <p className='text-base text-indigo-200'>
                          Troisième - 2015
                        </p>
                      </div>
                      <div className='pl-6 pr-6 pt-10 relative h-auto'>
                        ...
                        <p className='text-base text-gray-600 leading-8'>
                          Les professeurs sont de qualité et les cours en Ligne
                          sont très pratiques pour trouver des disponibilités,
                          en semaines comme en vacances je recommande.
                        </p>
                        <div className='flex justify-end mt-2'>
                          <svg
                            width={44}
